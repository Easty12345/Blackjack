...
public class ShowCard {
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        if (game.checkTotal(game.playerHand) == 21 && game.checkTotal(game.dealerHand) != 21) {
            ...
            System.out.println("The dealer hand contains " + game.dealerHand.get(0).getName() + " of " + game.dealerHand.get(0).getSuit() + " and " + game.dealerHand.get(1).getName() + " of " + game.dealerHand.get(1).getSuit() + ". A total of " + game.checkTotal(game.dealerHand));
            System.out.println("You win!");
            TimeUnit.SECONDS.sleep(2);
            System.exit(0);
        } else if (game.checkTotal(game.playerHand) == 21 && game.checkTotal(game.dealerHand) == 21) {
            System.out.println("You have Blackjack! Oh no, the dealer also has it! It's a draw!");
            TimeUnit.SECONDS.sleep(2);
            System.exit(0);
        }
